            ...
            <section className="pt-40 pb-20 px-6 max-w-7xl mx-auto">
                ...
                {featuredEvent && (
                    <motion.div
                        ...
                        className="group relative w-full h-[60vh] min-h-[500px] rounded-3xl overflow-hidden mb-24 border border-white/10 hover:border-neon-red/50 transition-all shadow-2xl"
                    >
                        <Image
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {regularEvents.map((event, i) => (
                        <motion.div
                            ...
                            className="group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-neon-red/30 transition-all flex flex-col"
                        >

...
export default function EventCard({ title, date, description, image }: EventCardProps) {
    return (
        <div className="group relative bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-neon-red/50 transition-all duration-300 hover:shadow-[0_0_30px_-5px_rgba(255,0,51,0.3)] hover:-translate-y-2">
            {/* Image Placeholder */}
            ...
            <div className="p-6">
                ...
                <button className="flex items-center gap-2 text-sm font-bold text-white group-hover:translate-x-1 transition-transform">
                    Start Registering
